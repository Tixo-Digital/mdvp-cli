...
- **61 unit tests** — `node:test` built-in, zero devDependencies; covers color-science, thresholds, scorer
...
- README rewritten: problem statement, component score table, JSON schema, methodology links, badges
