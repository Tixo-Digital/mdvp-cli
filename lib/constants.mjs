...
${BOLD}Common Flags${R}
  ...
  --exact                     Use rendered browser audit
...
${BOLD}Commands${R}
  ...
  audit <domain>              Score a website (static local audit, no API key)
  ...
  audit <domain> --exact      Rendered browser audit with full waits
...
${BOLD}Examples${R}
  ...
  mdvp audit stripe.com --exact --json
  mdvp audit mdvp.dev --swarm
  mdvp badge mdvp.dev
  mdvp compare figma.com linear.app
...
${BOLD}Notes${R}
  ...
  'audit' runs a static no-Chromium analyzer by default (no API key needed).
  Pass --exact when you need rendered DOM, computed styles, screenshots, or
  slower browser waits for a disputed result.
