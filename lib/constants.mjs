...
${BOLD}Common Flags${R}
  ...
  --exact                     Disable fast local audit shortcuts
...
${BOLD}Commands${R}
  ...
  audit <domain> --exact      Local audit with full browser waits
...
${BOLD}Notes${R}
  ...
  Local audit uses a fast metrics path by default; pass --exact when you
  need slower browser waits for a disputed result.
