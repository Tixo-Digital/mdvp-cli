...
${BOLD}Commands${R}
  ...
  submit <domain> --local     Crawl locally instead of using credits

${BOLD}Examples${R}
  mdvp login
  mdvp balance
  mdvp submit mdvp.dev
  mdvp submit mdvp.dev --local

${BOLD}Notes${R}
  Remote submit uses your MDVP account credits.
  '--local' is useful when iterating without spending credits.
  Run 'mdvp help' to go back to the topic index.`
